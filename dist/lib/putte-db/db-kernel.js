...
class DbManager {
    constructor(dbHost = app_settings_1.Settings.Database.dbHost, dbUser = app_settings_1.Settings.Database.dbUser, dbPass = app_settings_1.Settings.Database.dbPass, dbName = app_settings_1.Settings.Database.dbName, tag = "NO_TAG") {
        this.dbHost = dbHost;
        this.dbUser = dbUser;
        this.dbPass = dbPass;
        this.dbName = dbName;
